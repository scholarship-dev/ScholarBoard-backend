...
*/
function extractEthnicity(text_body) {
...
exports.extractEthnicity = extractEthnicity;
...
*/
function cleanTextBody(stringArray) {
    const clean_strings = [];
...
exports.cleanTextBody = cleanTextBody;
...
*/
function extractGrade(text_body) {
    const grades = [];
...
*/
function extractDeadline(textBody) {
    let deadline;
...
*/
function extractFunding(textBody) {
    const regex = /[0-9]+,[0-9]{3}/;
    const funding = textBody.match(regex);
    return funding[0];
}
exports.extractFunding = extractFunding;
...
*/
function extractEducationLevel(text_body) {
    const eduLevel = [];
...
exports.extractEducationLevel = extractEducationLevel;
